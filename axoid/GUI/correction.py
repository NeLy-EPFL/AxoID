...
class CorrectionPage(AxoidPage):
    ...
    def initUI(self):
        ...
        correction_btn = QPushButton("Manual annotation")
        correction_btn.setToolTip("Discard all results and move on to manual annotation (not implemented)")
        correction_btn.setEnabled(False)
        selection_btn = QPushButton("Back to model")
        selection_btn.setToolTip("Return to the model correction page")
        selection_btn.clicked.connect(self.gobackModel)
